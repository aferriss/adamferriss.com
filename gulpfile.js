...
gulp.task('gen', shell.task("node scripts/script.js"))

// gulp.task('gen', function(){
//   exec("node scripts/script.js")
// });
...
gulp.task('watch', function() {
  ...
  gulp.watch(path.join(src(), 'scripts/**/*.js'),['gen']);
...
gulp.task('default', ['gen','lint', 'sass', 'browserify', 'watch']);
